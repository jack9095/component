...
import com.alibaba.android.arouter.utils.TextUtils.getRight
...
class RecycleViewDivider: RecyclerView.ItemDecoration {
    ...
    private var mOrientation: Int = 0//列表的方向：LinearLayoutManager.VERTICAL或LinearLayoutManager.HORIZONTAL
